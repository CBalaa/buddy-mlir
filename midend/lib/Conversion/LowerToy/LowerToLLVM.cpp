...
struct ToyToLLVMLoweringPass
  ...
  StringRef getArgument() const final { return "lower-toy-to-llvm"; }
  StringRef getDescription() const final { return "Lower toy Dialect to LLVM IR."; }
...
namespace mlir {
namespace buddy {
void registerLowerToyToLLVMPass() { PassRegistration<ToyToLLVMLoweringPass>(); }
} // namespace buddy
} // namespace mlir
