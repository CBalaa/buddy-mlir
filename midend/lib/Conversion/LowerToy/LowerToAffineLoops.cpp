...
struct ToyToAffineLoweringPass
  ...
  StringRef getArgument() const final { return "lower-toy-to-affine-loop"; }
  StringRef getDescription() const final { return "Lower toy Dialect to affine loop."; }
...
namespace mlir {
namespace buddy {
void registerLowerToyToAffinePass() { PassRegistration<ToyToAffineLoweringPass>(); }
} // namespace buddy
} // namespace mlir
