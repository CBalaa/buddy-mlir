...
fegen::FegenType::FegenType(fegen::FegenType::TypeKind kind, llvm::StringRef dialectName, llvm::StringRef typeName, llvm::StringRef assemblyFormat, std::vector<FegenValue*>&& parameters, FegenParser::TypeDeclContext* ctx) :
...
fegen::FegenType* fegen::FegenType::get(fegen::FegenType::TypeKind kind, llvm::StringRef dialectName, llvm::StringRef typeName, llvm::StringRef assemblyFormat, std::vector<FegenValue*> parameters, FegenParser::TypeDeclContext* ctx) {
    return new fegen::FegenType(kind, dialectName, typeName, assemblyFormat, std::move(parameters), ctx);
}

fegen::FegenValue::FegenValue(bool isList, fegen::FegenType* type, llvm::StringRef name, FegenParser::VarDeclSpecContext* ctx) :
    isList(isList), type(type), name(name), ctx(ctx){}

fegen::FegenValue* fegen::FegenValue::get(bool isList, fegen::FegenType* type, llvm::StringRef name, FegenParser::VarDeclSpecContext* ctx){
